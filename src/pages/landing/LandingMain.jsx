...
const LandingMain = () => {
  ...
  return (
    <div className="landing-container" style={{ paddingTop: '70px' }}>
      <SEO
        title="NIKAH RAPI â€” Wedding Planner Digital #1 Indonesia | Budget, Vendor, Seserahan"
      ...
      <section className="hero">
        <div className="badge">âœ¦ Wedding Planner Khusus Pernikahan Indonesia</div>
        ...
        <h1 className="hero-title">
          ...
          â€” Dari Budget Sampai Seserahan
        </h1>
        <p className="hero-hook">
          "Stop pakai 5 spreadsheet berbeda yang bikin pusing.<br />
          NIKAH RAPI rapikan budget, vendor, tamu, seserahan, dan angpao kamu â€” semua di 1 dashboard."
        </p>
        <p className="hero-title-sub">
          22 modul terintegrasi Â· Otomatis kalkulasi Â· Bisa diakses berdua dengan pasangan
        </p>
        <div className="drama-tags">
          <span className="drama-tag">ðŸ˜° Budget Bocor</span>
          <span className="drama-tag">ðŸ“‹ Seserahan Kacau</span>
          <span className="drama-tag">ðŸ¢ Vendor Susah Ditrack</span>
          <span className="drama-tag">ðŸŽ Angpao Hilang Data</span>
        </div>
        ...
        <div className="hero-cta-block">
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center', marginTop: '20px' }}>
            ...
            >
              ðŸ’ Mulai Rapikan Pernikahanmu â†’
            </a>
            <button onClick={() => navigate('/demo')} className="btn-secondary">
              ðŸ‘ï¸ Coba Demo Dulu (Gratis)
            </button>
          </div>
          <div className="cta-notes">
            <div className="cta-note-item">âœ“ Garansi 7 hari</div>
            <div className="cta-note-item">âœ“ Akses instan via WA</div>
            <div className="cta-note-item">âœ“ Tersimpan aman di Cloud</div>
          </div>
        </div>
        ...
        <div className="social-proof-bar">
          <div className="sp-avatars">
            ...
            <div className="sp-avatar" style={{ background: 'linear-gradient(135deg,#C9A96E,#E8D5B0)' }}>ðŸ‘‘</div>
            <div className="sp-avatar" style={{ background: 'linear-gradient(135deg,#A8B8AC,#7A8C7E)' }}>ðŸƒ</div>
          </div>
      ...
      <section className="video-section" id="cara-kerja">
        <p className="section-eyebrow reveal">âœ¨ Intip Dulu Sebelum Beli</p>
        ...
        <div className="video-wrapper reveal">
          <div className="video-placeholder" ref={videoRef} onClick={loadVideo}>
            ...
            <div className="video-overlay-text">
              <span className="video-badge-tag">â–¶ Preview Demo</span>
            </div>
          </div>
        </div>
        <div className="video-features reveal">
          <div className="vf-card">
            <div className="vf-icon">ðŸ’</div>
      ...
      <section className="drama-section">
        ...
        <div className="drama-grid">
          {[
            { icon: 'ðŸ’°', title: 'Drama Budget Jebol', desc: 'Estimasi Rp 80jt, realisasi Rp 120jt. Pengeluaran kecil-kecil yang tidak tercatat akhirnya numpuk tanpa disadari.', scenario: '"Udah bayar DP katering, eh lupa dicatat. Sekarang gak tau sisa budget berapa."' },
            { icon: 'ðŸ’', title: 'Drama Seserahan Ketinggalan', desc: 'Daftar seserahan ditulis di kertas, notes HP, chat WA â€” tersebar mana-mana. Hari H ada barang yang ketinggalan.', scenario: '"Sampai di lokasi baru sadar parfum seserahan ketinggalan di rumah. Panik!"' },
            { icon: 'ðŸ¢', title: 'Drama Vendor Cabut', desc: 'Vendor cancel H-7, nomor susah dihubungi, kontrak tidak jelas. Semua info vendor tersebar di berbagai chat WA.', scenario: '"WO tiba-tiba bilang ada double booking. Kontraknya mana? Sudah bayar berapa?"' },
            { icon: 'ðŸ’„', title: 'Drama MUA Double Booking', desc: 'MUA impian ternyata sudah di-booking orang lain di tanggal yang sama. Baru ketahuan 2 minggu sebelum hari H.', scenario: '"Udah fitting 3x, eh MUA-nya bilang double booking. Cari pengganti mendadak."' },
            { icon: 'ðŸŽ', title: 'Drama Kado & Angpao Kacau', desc: 'Siapa yang kasih kado apa? Amplop dari siapa? Mau kirim ucapan terima kasih tapi datanya tidak ada.', scenario: '"Mau WA ucapan terima kasih tapi lupa siapa yang kasih angpao berapa. Awkward."' },
            { icon: 'ðŸ˜«', title: 'Drama Tamu Overload', desc: 'Undangan 300 orang, kursi cuma 250. Konfirmasi hadir berantakan, catering kurang, meja tidak cukup.', scenario: '"Tamu yang konfirmasi hadir ternyata lebih dari kapasitas gedung. Chaos!"' }
          ].map((item, i) => (
        ...
        <p className="drama-closer reveal">"Semua drama ini bisa dihindari â€” kalau semua tercatat di satu tempat yang benar."</p>
      </section>
      ...
      <section className="solution-section" id="fitur">
        <div className="solution-inner">
          <div className="solution-left">
            ...
            <p className="reveal">
              NIKAH RAPI dirancang khusus untuk calon pengantin Indonesia â€” 22+ modul Web App terintegrasi yang saling terhubung otomatis. 
          ...
          <div className="feature-cards">
            {[
              { icon: 'ðŸ’', title: 'Seserahan Tracker', tag: 'Eksklusif', desc: 'Catat semua item, harga, status beli. Auto-hitung total. Tidak ada di produk manapun di Indonesia.' },
              { icon: 'ðŸŽ', title: 'Kado & Angpao Tracker', tag: 'Eksklusif', desc: 'Rekap siapa beri apa, nominal angpao, status ucapan terima kasih. Tidak ada yang terlewat.' },
              { icon: 'ðŸ’°', title: 'Budget Planner Otomatis', desc: 'Rencana vs realisasi terupdate real-time. Tahu persis kategori mana yang overbudget sebelum terlambat.' },
              { icon: 'ðŸ¢', title: 'Vendor Manager Lengkap', desc: 'Kontak, kontrak, DP & pelunasan semua vendor. Tidak ada lagi vendor yang tiba-tiba "lupa" perjanjian.' }
            ].map((feat, i) => (
          ...
          <table className="diff-table">
            ...
            <tbody>
              {[
                ...
                <tr key={i}>
                  <td>{row[0]}</td>
                  <td style={{ textAlign: 'center' }}>{row[1] ? 'âœ“' : 'âœ•'}</td>
                  <td style={{ textAlign: 'center' }}>{row[2] ? 'âœ“' : 'âœ•'}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="testi-section">
        ...
        <div className="testi-photo-grid">
          {[
            { emoji: 'ðŸŒ¸', bg: 'linear-gradient(135deg,#E8C4B8,#C4857A)', city: 'Jakarta', text: '"Seserahan Tracker-nya beneran game changer! Sebelumnya nyatat manual di kertas, ada yang ketinggalan terus. Sekarang tinggal ceklis, dan bisa di-akses suami juga."', name: 'Anisa R.', role: 'Calon Pengantin Â· Sept 2025' },
            { emoji: 'ðŸ’‘', bg: 'linear-gradient(135deg,#8B5E6A,#C9A96E)', city: 'Bandung', text: '"Berdua bisa update real-time. Saya isi data vendor, calon istri ngurus seserahan, semuanya keliatan di dashboard yang sama. Anti drama \'kok ini belum dibayar\'."', name: 'Reza & Putri', role: 'Pasangan Â· Nov 2025' },
            { emoji: 'ðŸ‘©', bg: 'linear-gradient(135deg,#C9A96E,#8B5E6A)', city: 'Surabaya', text: '"Anak saya di Jakarta, saya di Surabaya. Sejak pakai NIKAH RAPI, semua list seserahan dan keperluan akad bisa saya pantau dari rumah. Tinggal bagi tugas, semua tercatat rapi."', name: 'Bunda Sri W.', role: 'Ibu Calon Pengantin Â· Jan 2026' }
          ].map((t, i) => (
        ...
        <div className="testi-stats reveal">
          ...
          <div className="tstat"><div className="tstat-num">4.9â˜…</div><div style={{ fontSize: 12, color: 'var(--text-light)' }}>Rating dari early users</div></div>
      ...
      <section className="pricing-section" id="pricing">
        ...
        <div className="pricing-card reveal">
          ...
          <ul className="include-list">
            ...
            <li>Kado & Angpao Tracker eksklusif â€” follow up terima kasih mudah</li>
          ...
          >
            ðŸ’ Dapatkan Sekarang â€” Rp 99.000
          </a>
      ...
      <section className="faq-section" id="faq">
        ...
        <div className="faq-inner">
          {[
            { q: 'Saya gaptek, bisa pakai tidak?', a: 'Tidak perlu jago teknologi! NIKAH RAPI dirancang agar tinggal isi data â€” semua kalkulasi dan dashboard berjalan otomatis. Kalau kamu bisa ngetik di HP, kamu sudah bisa pakai NIKAH RAPI.' },
            ...
            { q: 'Bisa untuk pernikahan adat apa saja?', a: 'Bisa untuk semua adat â€” Jawa, Sunda, Minang, Betawi, Modern, dan lainnya. Template kami fleksibel dan bisa disesuaikan.' },
            { q: 'Apa bedanya dengan wedding planner lain?', a: 'NIKAH RAPI adalah satu-satunya Web App wedding planner yang punya Seserahan Tracker & Kado/Angpao Tracker â€” dua fitur yang paling dibutuhkan calon pengantin Indonesia tapi tidak ada di produk manapun.' }
          ].map((item, i) => (
      ...
      <section className="final-cta">
        ...
        <a href={checkoutUrl} className="btn-secondary reveal" style={{ margin: '0 auto', background: 'white', color: 'var(--mauve)', border: 'none' }}>
          ðŸ’ Ambil Sekarang Sebelum Harga Naik
        </a>
      </section>
      ...
      <footer style={{ background: '#2C2218', padding: '40px 80px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'white', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ fontSize: '12px', opacity: 0.7, display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
          <span>Â© 2025 NIKAH RAPI Â· Wedding Planner Digital Premium Â· Made with love ðŸ¤</span>
