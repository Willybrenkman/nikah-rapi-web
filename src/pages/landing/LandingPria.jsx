...
const LandingPria = () => {
  ...
  return (
    <div className="landing-container" style={{ paddingTop: '70px' }}>
      <SEO
        title="Nikah Anti Boncos â€” Budget Terkontrol Sampai Hari H | NIKAH RAPI untuk Pria"
      ...
      <section className="hero">
        <div className="badge">âœ¦ Untuk Calon Suami yang Mau Pegang Kendali</div>
        ...
        <p className="hero-hook">
          ...
          NIKAH RAPI kasih kamu visibility 100% atas budget, vendor, dan progress â€” langsung dari HP."
        </p>
        <p className="hero-title-sub">
          Tracking real-time Â· DP & pelunasan vendor terpantau Â· Bisa share dashboard ke pasangan
        </p>
        <div className="drama-tags">
          <span className="drama-tag">ðŸ’¸ Budget Bocor Halus</span>
          <span className="drama-tag">ðŸ¤· Gak Tau Vendor Udah Lunas</span>
          <span className="drama-tag">ðŸ“‰ Tabungan Habis Sebelum H-1</span>
        </div>

        <div className="product-showcase">
          <div className="showcase-glow"></div>
          <div className="float-badge float-badge-top">
            <div className="fb-icon" style={{ background: '#FFF0EC' }}>ðŸ’°</div>
            <div>
              <div className="fb-label">Budget Planner</div>
              <div className="fb-val">Rp 95.5jt / 120jt terkontrol âœ“</div>
            </div>
          </div>
          <div className="float-badge float-badge-bot">
            ...
            <div>
              ...
              <div className="fb-val">8/10 vendor lunas âœ“</div>
            </div>
          </div>
        ...
        <div className="hero-cta-block">
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center', marginTop: '20px' }}>
            ...
            >
              âš¡ Ambil Kendali Budget Sekarang â†’
            </a>
            <button onClick={() => navigate('/demo')} className="btn-secondary">
              ðŸ“Š Lihat Cara Kerjanya
            </button>
          </div>
          <div className="cta-notes">
            <div className="cta-note-item">âœ“ Sekali bayar, akses seumur hidup</div>
            <div className="cta-note-item">âœ“ Garansi 7 hari uang kembali</div>
            <div className="cta-note-item">âœ“ Akses dari HP kapan saja</div>
          </div>
        </div>

        <div className="social-proof-bar">
          <div className="sp-avatars">
            <div className="sp-avatar" style={{ background: 'linear-gradient(135deg,#5C7361,#8BAF8B)' }}>ðŸ’¼</div>
            <div className="sp-avatar" style={{ background: 'linear-gradient(135deg,#C9A96E,#E8D5B0)' }}>ðŸ”¥</div>
            <div className="sp-avatar" style={{ background: 'linear-gradient(135deg,#8B5E6A,#C4857A)' }}>âš¡</div>
            <div className="sp-avatar" style={{ background: 'linear-gradient(135deg,#A8B8AC,#7A8C7E)' }}>ðŸŽ¯</div>
          </div>
      ...
      <section className="drama-section" id="masalah">
        ...
        <div className="drama-grid">
          {[
            { icon: 'ðŸ’¸', title: 'Budget Bocor Halus', desc: 'Pengeluaran kecil yang tidak tercatat tahu-tahu bikin tabungan minus. Total Rp 120jt, realisasi entah berapa.', scenario: '"Eh kok tabungan nikah tinggal segini? Kemarin kan masih banyak... pengeluaran apa aja sih?"' },
            { icon: 'ðŸ¤¯', title: 'Koordinasi Vendor Rumit', desc: 'Capek tanya "ini sudah lunas belum?" ke pasangan. DP katering, pelunasan gedung, cicilan MUA â€” semua di chat WA yang berbeda.', scenario: '"Vendor fotografer bilang belum lunas, tapi kamu bilang udah transfer. Buktinya mana?"' },
            { icon: 'ðŸ“Š', title: 'Gak Tahu Progress', desc: 'Persiapan sudah berapa persen? Apa yang urgent? Semua tersebar di notes, Excel, dan kepala â€” tidak ada satu dashboard.', scenario: '"Pasangan nanya udah sampai mana, kamu cuma bisa jawab \'lagi diproses\'. Gak ada datanya."' },
            { icon: 'ðŸ¢', title: 'Vendor Cancel Mendadak', desc: 'Vendor tiba-tiba cancel H-7, nomor susah dihubungi. Kontrak dan bukti DP tidak tersimpan rapi.', scenario: '"WO bilang double booking. Bukti kontraknya? Di chat WA yang udah ketimpa ribuan pesan."' },
            { icon: 'ðŸ’', title: 'Seserahan Berantakan', desc: 'List seserahan ditulis di kertas, notes HP, dan chat WA. Hari H ada barang yang ketinggalan karena gak ada satu daftar resmi.', scenario: '"Sampai di rumah mertua baru sadar parfum seserahan ketinggalan. Malu bukan main."' },
            { icon: 'ðŸ˜¤', title: 'Ribut Soal Uang', desc: 'Pasangan merasa kamu gak transparan soal keuangan nikah. Padahal kamu juga bingung karena datanya tersebar.', scenario: '"Aku udah transfer berapa kali buat nikah ini, kamu gak pernah kasih laporan jelas."' }
          ].map((item, i) => (
        ...
        <p className="drama-closer reveal">"Semua drama ini bisa dihindari â€” kalau kamu punya sistem yang proper untuk tracking semuanya."</p>
      </section>
      ...
      <section className="solution-section" id="fitur">
        <div className="solution-inner">
          ...
          <div className="feature-cards">
            {[
              { icon: 'ðŸ’°', title: 'Budget Planner Otomatis', desc: 'Rencana vs realisasi terupdate real-time. Tahu persis mana yang mulai overbudget sebelum terlambat.' },
              { icon: 'ðŸ¢', title: 'Vendor Manager Lengkap', desc: 'Pantau histori cicilan DP dan deadline pelunasan vendor. Tidak ada lagi vendor yang "lupa" perjanjian.' },
              { icon: 'ðŸ’', title: 'Seserahan Tracker', tag: 'Eksklusif', desc: 'Catat barang apa saja yang sudah dibeli dan berapa sisa budgetnya. Auto-hitung total.' },
              { icon: 'ðŸŽ', title: 'Kado & Angpao Tracker', tag: 'Eksklusif', desc: 'Rekap siapa beri apa, nominal angpao. Pencatatan terpusat mencegah kehilangan data.' }
            ].map((feat, i) => (
      ...
      <section className="testi-section">
        ...
        <div className="testi-photo-grid">
          {[
            { emoji: 'ðŸ’¼', bg: 'linear-gradient(135deg,#5C7361,#8BAF8B)', city: 'Jakarta', text: '"Gue orangnya sistematis. NIKAH RAPI cocok banget â€” semua vendor, budget, dan deadline ada di satu dashboard. Pasangan gue juga bisa akses, jadi gak ada lagi drama \'kok gak transparan\'."', name: 'Reza A.', role: 'Calon Pengantin Â· Nov 2025' },
            { emoji: 'âš¡', bg: 'linear-gradient(135deg,#C9A96E,#8B5E6A)', city: 'Bandung', text: '"Budget planner-nya beneran game changer. Gue bisa lihat persis kategori mana yang mulai overbudget. Estimasi 80jt, realisasi bisa dikontrol di 82jt. Tanpa ini pasti jebol."', name: 'Dimas P.', role: 'Calon Pengantin Â· Jan 2026' },
            { emoji: 'ðŸŽ¯', bg: 'linear-gradient(135deg,#8B5E6A,#C9A96E)', city: 'Surabaya', text: '"Awalnya skeptis â€” cowok kok pakai wedding planner app. Tapi setelah coba, ini lebih ke financial tracker + project manager buat nikah. Exactly what I needed."', name: 'Ari W.', role: 'Calon Pengantin Â· Mar 2026' }
          ].map((t, i) => (
      ...
      <section className="pricing-section" id="pricing">
        ...
        <div className="pricing-card reveal">
          ...
          <ul className="include-list">
            ...
            <li>Budget Planner otomatis â€” kontrol penuh atas keuangan nikah</li>
            <li>Vendor Manager â€” tracking DP, cicilan, dan pelunasan</li>
          ...
          >
            âš¡ Amankan Promo Sekarang â€” Rp 99.000
          </a>
      ...
      <section className="faq-section" id="faq">
        ...
        <div className="faq-inner">
          {[
            ...
            { q: 'Ini bukan cuma "wedding planner cewek"?', a: 'Bukan. NIKAH RAPI itu lebih ke financial tracker + project manager untuk pernikahan. Budget planner, vendor manager, deadline tracking â€” tools yang pria butuhkan.' },
      ...
      <section className="final-cta">
        ...
        <a href={checkoutUrl} className="btn-secondary reveal" style={{ margin: '0 auto', background: 'white', color: 'var(--mauve)', border: 'none' }}>
          âš¡ Dapatkan NIKAH RAPI Sekarang
        </a>
      </section>
      ...
      <footer style={{ background: '#2C2218', padding: '40px 80px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'white', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ fontSize: '12px', opacity: 0.7 }}>Â© 2025 NIKAH RAPI Â· Untuk Pria Terencana Indonesia ðŸ¤</div>
      </footer>
    </div>
  );
};
