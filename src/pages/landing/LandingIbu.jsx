...
const LandingIbu = () => {
  ...
  return (
    <div className="landing-container" style={{ paddingTop: '70px' }}>
      <SEO
        title="Hadiah Pernikahan Terbaik dari Ibu | NIKAH RAPI â€” Wedding Planner Digital"
      ...
      <section className="hero">
        <div className="badge">âœ¦ Hadiah Pernikahan Paling Bermanfaat dari Ibu</div>
        <p className="hero-eyebrow">Untuk Ibu yang ingin anak menikah dengan tenang, bukan kelelahan</p>
        <h1 className="hero-title">
          Bantu Anak Ibu Menikah <em>Tanpa Drama</em><br />â€” Tanpa Ibu Harus Ikut Kelelahan
        </h1>
        ...
        <p className="hero-title-sub">
          Bisa diakses Ibu dari rumah Â· Anak yang isi data Â· Ibu bisa pantau dari HP
        </p>
        ...
        <div className="hero-cta-block">
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center', marginTop: '20px' }}>
            ...
            >
              ðŸ’ Hadiahkan untuk Anak Ibu â†’
            </a>
            <button onClick={() => navigate('/demo')} className="btn-secondary">
              ðŸ‘ï¸ Lihat Tampilan App
            </button>
          </div>
          <div className="cta-notes">
            <div className="cta-note-item">âœ“ Akses Ibu & anak sekaligus</div>
            <div className="cta-note-item">âœ“ Sederhana, tidak ribet</div>
            <div className="cta-note-item">âœ“ Garansi 7 hari</div>
          </div>
        </div>
      </section>

      {/* â•â• DRAMA (IBU VERSION) â•â• */}
      <section className="drama-section" id="masalah">
        ...
        <div className="drama-grid">
          {[
            { icon: 'ðŸ˜°', title: 'Takut Ada Yang Terlewat', desc: 'Daftar undangan, katering, sampai kain seragam keluarga. Terlalu banyak detail yang bikin Ibu susah tidur.', scenario: '"Aduh, kain seragam keluarganya udah dipesan belum ya? Siapa yang ngurusin?"' },
            { icon: 'ðŸ’°', title: 'Anggaran Tidak Terkontrol', desc: 'Pengeluaran tak terduga yang bikin kaget di akhir. Ibu ingin semua transparan dan terencana sejak awal.', scenario: '"Kok budget-nya tiba-tiba bengkak? Kemarin katanya cukup..."' },
            { icon: 'ðŸ“‹', title: 'Koordinasi Jarak Jauh', desc: 'Anak di kota lain, Ibu di kampung. Susah memantau sudah sampai mana persiapan. Ingin semua bisa dilihat dari HP.', scenario: '"Nak, seserahan-nya udah lengkap belum? Ibu khawatir ada yang kurang."' }
          ].map((item, i) => (
        ...
        <p className="drama-closer reveal">"Ibu berhak menikmati momen bahagia â€” bukan dihantui kekhawatiran yang tak berujung."</p>
      </section>
      ...
      <section className="solution-section" id="fitur">
        <div className="solution-inner">
          <div className="solution-left">
            ...
            <p className="reveal">
              NIKAH RAPI dirancang khusus untuk keluarga calon pengantin Indonesia â€” 22+ modul Web App terintegrasi. 
          ...
          <div className="feature-cards">
            {[
              { icon: 'ðŸ’', title: 'Seserahan Tracker', tag: 'Eksklusif', desc: 'Catat semua item seserahan, harga, dan status pembelian. Ibu bisa pantau langsung dari HP.' },
              ...
              { icon: 'ðŸ’°', title: 'Budget Planner Otomatis', desc: 'Transparan dan real-time. Ibu bisa tahu persis total pengeluaran vs rencana awal.' },
              { icon: 'ðŸ¢', title: 'Vendor Manager Lengkap', desc: 'Semua kontak, kontrak, dan status pembayaran vendor â€” terpusat di satu tempat aman.' }
            ].map((feat, i) => (
      ...
      <section className="testi-section">
        ...
        <div className="testi-photo-grid">
          {[
            { emoji: 'ðŸ‘©', bg: 'linear-gradient(135deg,#C9A96E,#8B5E6A)', city: 'Surabaya', text: '"Anak saya kerja di Jakarta, saya di Surabaya. Sejak pakai NIKAH RAPI, semua list seserahan dan keperluan akad bisa saya pantau dari rumah. Tinggal bagi tugas, semua tercatat rapi."', name: 'Bunda Sri W.', role: 'Ibu Calon Pengantin Â· Okt 2025' },
            { emoji: 'ðŸŒ¸', bg: 'linear-gradient(135deg,#E8C4B8,#C4857A)', city: 'Yogyakarta', text: '"Saya senang sekali ada aplikasi ini. Budget pernikahan anak saya jadi terkontrol, dan saya bisa bantu awasi tanpa harus ikut campur berlebihan. Terima kasih NIKAH RAPI!"', name: 'Ibu Siti H.', role: 'Ibu Calon Pengantin Â· Des 2025' },
            { emoji: 'ðŸ’', bg: 'linear-gradient(135deg,#8B5E6A,#C9A96E)', city: 'Bekasi', text: '"Awalnya skeptis, tapi ternyata gampang banget dipakainya. Sekarang saya dan anak saya bisa koordinasi persiapan nikah tanpa harus telpon-telponan tiap malam."', name: 'Mama Linda', role: 'Ibu Calon Pengantin Â· Agu 2025' }
          ].map((t, i) => (
      ...
      <section className="pricing-section" id="pricing">
        ...
        <div className="pricing-card reveal">
          ...
          <ul className="include-list">
            ...
            <li>Seserahan Tracker eksklusif â€” pantau dari HP Ibu!</li>
            <li>Kado & Angpao Tracker â€” follow up terima kasih mudah</li>
            <li>Dashboard otomatis update â€” lihat progress anak kapan saja</li>
          ...
          >
            ðŸ’ Hadiahkan Sekarang â€” Rp 99.000
          </a>
      ...
      <section className="faq-section" id="faq">
        ...
        <div className="faq-inner">
          {[
            { q: 'Saya gaptek, bisa pakai tidak?', a: 'Tidak perlu jago teknologi! NIKAH RAPI dirancang agar tinggal isi data â€” semua kalkulasi dan dashboard berjalan otomatis. Kalau Ibu bisa pakai WhatsApp, Ibu sudah bisa pakai ini.' },
      ...
      <section className="final-cta">
        ...
        <a href={checkoutUrl} className="btn-secondary reveal" style={{ margin: '0 auto', background: 'white', color: 'var(--mauve)', border: 'none' }}>
          ðŸ’ Hadiahkan NIKAH RAPI Untuk Anak Ibu
        </a>
      </section>
      ...
      <footer style={{ background: '#2C2218', padding: '40px 80px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'white', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ fontSize: '12px', opacity: 0.7 }}>Â© 2025 NIKAH RAPI Â· Untuk Ibu & Keluarga Indonesia ðŸ¤</div>
      </footer>
    </div>
  );
};
